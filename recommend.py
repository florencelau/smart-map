...
def find_closest(location, centroids):
    ...
    """
    # BEGIN Question 3
    return min(centroids, key = lambda centroid_location: distance(location, centroid_location))
    # END Question 3
...
def rate_all(user, restaurants, feature_fns):
    ...
    for r in restaurants:
        if r in reviewed:
            restaurant_ratings[restaurant_name(r)] = user_rating(user, restaurant_name(r))
        else:
            restaurant_ratings[restaurant_name(r)] = predictor(r)
